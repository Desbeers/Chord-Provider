                    ...
                    VStack {
                        ...
                        ScrollView {
                            if databaseState.filteredChords.isEmpty {
                                let chordDisplay = databaseState.chord.naturalAndAccidentalDisplay
                                StatusPage(
                                    "No chords found",
                                    icon: .default(icon: .systemSearch),
                                    description: "Couldn't find any \(databaseState.search.isEmpty ? "\(chordDisplay) chords" : "chords that match your search")."
                                )
                                .transition(.crossfade)
                            } else {
                                FlowBox(
