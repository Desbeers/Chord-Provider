...
var ChordJS = (function(){
    ...
    var MUTED = -1;
    var FRET_COUNT = 5;
    var FONT_NAME = "Helvetica Neue";
    
    var ChordBoxImage = function(name, accentColor, highlightColor, chordColor, chord, fingers, size, stringNames) {
        ...
        var InitializeSizes = function() {
            ...
            _nameFontSize = _fretWidth * 1 / perc;
        ...
        var CreateImage = function(ctx,layout) {
            _ctx = ctx;
            _graphics.FillRectangle('transparent', 0, 0, _imageWidth, _imageHeight);
            if (_error) {
                //Draw red x
        ...
        var DrawChordBox = function() {
            ...
            if (_baseFret == 1) {
                ...
                _graphics.FillRectangle(chordColor, _xstart - _lineWidth / 2, _ystart - nutHeight, _boxWidth, nutHeight);
            }
        };
        ...
        var DrawBars = function() {
            ...
            var pen = Pen(chordColor, _lineWidth * 3);
            var totalFretWidth = _fretWidth + _lineWidth;
            for (var b in bars) {
                if (bars.hasOwnProperty(b)){
                    ...
                    pen = Pen(chordColor, _dotWidth / 2);
        ...
        var DrawChordPositions = function() {
            ...
            for (var i = 0; i < _chordPositions.length; i++) {
                ...
                if (relativePos > 0) {
                    ...
                    _graphics.FillCircle(chordColor, xpos, ypos, _dotWidth);
        ...
        var DrawStringNames = function() {
            ...
            for (var s=0; s<6; s++) {
                ...
                _graphics.DrawString(guitarString, font, accentColor, xpos - (0.5 * charSize.Width), ypos);
                xpos += (_fretWidth + _lineWidth);
            }
        };
        ...
        var DrawChordName = function() {
            ...
            if (_baseFret > 1) {
                ...
                _graphics.DrawString(_baseFret + "fr", fretFont, chordColor, _xstart + _boxWidth + 0.4 * _fretWidth, _ystart - offset);
            }
        };
    ...
    function GenerateChordHtml(name, accentColor, highlightColor, chordColor, positions, fingering, size, layout, stringNames) {
        ...
        var chordObj = ChordBoxImage(name, accentColor, highlightColor, chordColor, positions, fingering, size, stringNames);
    ...
    var ReplaceChordElements = function(baseEl) {
          ...
          for(var i=0; i<chords.length; ++i) {
            ...
            var accentColor = elt.getAttribute('accentColor')
            var highlightColor = elt.getAttribute('highlightColor')
            var chordColor = elt.getAttribute('chordColor')
            var canvas = GenerateChordHtml(name, accentColor, highlightColor, chordColor,positions, fingers, size, layout, stringNames);
