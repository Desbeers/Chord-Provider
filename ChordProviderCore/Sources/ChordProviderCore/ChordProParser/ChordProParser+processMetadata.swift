...
extension ChordProParser {
    ...
    static func processMetadata(
        ...
        if song.metadata.definedMetadata.contains(directive.source.long),
            ...
            song.metadata.definedMetadata.insert(directive.source.long)
        }
        ...
        case .key:
            if let label, var chord = ChordDefinition(name: label, chords: song.settings.chordDefinitions) {
