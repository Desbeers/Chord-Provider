...
extension Array where Element == ChordDefinition {
    ...
    public func matching(root: Chord.Root) -> [ChordDefinition] {
    ...
    /// - Returns: All matching chord definitions
    public func matching(sharpAndflatRoot: Chord.Root) -> [ChordDefinition] {
    ...
    /// - Returns: All matching chord definitions
    public func matching(quality: Chord.Quality) -> [ChordDefinition] {
