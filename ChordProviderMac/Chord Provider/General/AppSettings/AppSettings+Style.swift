...
extension AppSettings.Style {
    ...
    enum FontPreset: String, CaseIterable {
        ...
        func presets(style: AppSettings.Style, fonts: [FontUtils.Item]) -> AppSettings.Style {
...
extension AppSettings.Style {
    ...
    struct Fonts: Codable, Equatable {
        /// {title ...}
        var title = FontUtils.Options(size: 18)
        /// {subtitle ...}
        var subtitle = FontUtils.Options(size: 16)
        ...
        /// {tag ...}
        var tag = FontUtils.Options(size: 8)
        /// {textblock} environment
        var textblock = FontUtils.Options(size: 11)
    }
}
